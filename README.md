...
The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/home/z572/gits/rockos-ros/venv/bin/bloom-release -r jazzy clearpath_common --override-release-repository-push-url git@github.com:rockos-riscv-ros/clearpath_common-release.git` on `Fri, 21 Mar 2025 07:02:01 -0000`
...
- release repository: https://github.com/rockos-riscv-ros/clearpath_common-release.git
